...
class ReleaseWorkflowContractTest(unittest.TestCase):
    def test_release_v3_runs_protected_target_jobs_and_verifies_their_immutable_graph(self) -> None:
        ...
        self.assertIn("--manifest-version 8", release)
        self.assertIn(
            "application/vnd.scholarsense.release-manifest.v8+json", release
        )
        self.assertIn(
            "application/vnd.scholarsense.evidence-index.v8+json", release
        )
        ...
        self.assertIn("RELEASE-MANIFEST-8.0.0", verifier)
