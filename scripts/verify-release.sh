...
case "$MANIFEST_VERSION" in
  ...
  RELEASE-MANIFEST-2.0.0)
    ...
    ;;
  RELEASE-MANIFEST-3.0.0|RELEASE-MANIFEST-4.0.0|RELEASE-MANIFEST-5.0.0|RELEASE-MANIFEST-6.0.0|RELEASE-MANIFEST-7.0.0|RELEASE-MANIFEST-8.0.0|RELEASE-MANIFEST-9.0.0)
